...
namespace OpenML.BookStore.Infrastructure.Migrations
{
    public partial class BookStore : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "WareHouse_Books",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WareHouseCodeId = table.Column<int>(type: "int", nullable: false),
                    BookId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareHouse_Books", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WareHouse_Books_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WareHouse_Books_Warehouses_WareHouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WareHouse_Books_BookId",
                table: "WareHouse_Books",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_WareHouse_Books_WareHouseId",
                table: "WareHouse_Books",
                column: "WareHouseId");
        }
